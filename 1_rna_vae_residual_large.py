...
if __name__ == '__main__':
    ...
    project_dir = 'runs/rna_vae_residual_large'
    train_steps = 20000
    eval_points = 100
    save_points = 4000
    ...
    rna_model.set_dataloader(batch_size = 2048)
    rna_model.set_loss(beta = 1)
    rna_model.set_optimizer(lr = 1e-4, warmup_steps=100, steady_1_steps = 100, cosine_anneal_steps=100, min_lr = 1e-6)
