'''
Implementation of the SR tiny model

for users do not use pretrained model, or do not need to train on a large dataset,
we provide a tiny version of the SR model,
tiny model has less parameters and do not need to write config file,
more flexible with anndata
''' 
import torch 
